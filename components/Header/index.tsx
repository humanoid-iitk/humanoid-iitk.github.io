      ...
      >
        <div className='container'>
          <div className='relative -mx-4 flex items-center justify-between'>
            <div className='w-60 max-w-full px-4 pl-10 xl:mr-12'>
              <Link
                href='/'
              ...
              >
                ...
                <Image
                  ...
                  height={30}
                  color="#FFFFFF"
                  className='hidden max-w-10 h-12 dark:block'
                />
              </Link>
            </div>
            <div className='flex w-full items-center justify-between px-4 pl-40'>
              <div>
                <button
